...
PortSIP released the v16.4. version to supports the new push method for Android notifications. All PortSIP PBX v16.x installation need to be upgrade to the v16.4 as change settings as this guide to ensure the push notifications to work fine.
...
Please upgrade your current PBX v16.x to v16.4 per as this guide: [Upgrading PortSIP PBX to New Versions](portsip-pbx-administration-guide/upgrading-portsip-pbx-to-new-versions.md).
...
* Open the Push Profile JSON file, copy the contents and paste them to the **FCM Service account key JSON** file and save your changes.
