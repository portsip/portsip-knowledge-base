...
For example, if your PortSIP PBX domain is `sip.yourpbx.com`, and the PBX static IP is `98.11.99.12`, and the PBX use port 5060 over UDP to communicates with Wavix trunk, the SIP URI can be one of the below formats:
...
Please make sure that all your Wavix DIDs are setup in the DID Pool of the Wavix Trunk you configured in the PortSIP PBX.
