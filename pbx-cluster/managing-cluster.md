...
2. Install the latest version of the server. Follow the instructions provided in the [Configuring Cluster Servers](configuring-cluster-servers-for-portsip-pbx-ha.md) guide to complete this step.
