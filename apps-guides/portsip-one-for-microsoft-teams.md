...
After installation, if the **SIPS protocol association** is not set to PortSIP ONE for Microsoft  Teams, you must configure it manually.

#### Windows 11

On Windows 11, if the app detects that the default application for the sips: link is not **PortSIP ONE for  Microsoft Teams**, it will automatically navigate you to the **Set default file types or link types** settings page.

When prompted, the system opens Set default file types or link types. Locate the SIPS protocol. Select **PortSIP ONE for Microsoft Teams as the default application**. No additional manual steps are required.
...
4. Click the app icon on the right and select **PortSIP ONE for Microsoft  Teams** as the default application

***

### Installing the PortSIP ONE for Teams App in Microsoft Teams

1. Download the PortSIP ONE for Microsoft  Teams app package from the [PortSIP website](https://www.portsip.com/downloads/portsip1/portsip-one-for-teams-plug.zip).&#x20;
...
1. In Microsoft Teams, click the **PortSIP ONE for Microsoft Teams** icon to launch the application.
2. **Sign in manually**:
...
4. After successful login, you can use PortSIP ONE for Microsoft  Teams to:
...
If you encounter any issues during installation or while using PortSIP ONE for Microsoft Teams, please contact the [PortSIP Technical Support Team](mailto:support@portsip.com) for assistance.
