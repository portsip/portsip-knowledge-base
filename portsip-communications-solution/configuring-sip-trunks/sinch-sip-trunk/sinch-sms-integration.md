...
Before proceeding with the next steps, you need to [purchase a DID on the Telnyx platform](../telnyx-sip-trunk/purchase-a-did-on-telnyx-platform.md) with **SMS/MMS enabled**.
...
* [Configuring Telnyx Register Based Trunk](../telnyx-sip-trunk/configuring-telnyx-register-authentication-trunk.md)
* [Configuring Telnyx IP Based Trunk](../telnyx-sip-trunk/configuring-telnyx-ip-authentication-trunk.md)
...
You can now [create outbound and inbound rules](../telnyx-sip-trunk/configuring-outbound-and-inbound-calls.md) in PortSIP PBX to send and receive SMS/MMS messages using the Telnyx trunk, just as you would configure rules for outbound and inbound voice calls.
