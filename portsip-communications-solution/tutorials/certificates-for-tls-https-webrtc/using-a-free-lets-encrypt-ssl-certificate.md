...
Once the certificate files are ready, follow the guide [**Update Certificates**](../../portsip-pbx-administration-guide/certificates-for-tls-https-webrtc/update-certificates.md) to apply the new TLS certificates to your PortSIP PBX system.
