...
3. If your PortSIP PBX is hosted on a cloud platform such as **AWS, Microsoft Azure, or Google Cloud (GCE)**, you must configure network security rules to allow media traffic.
   ...
   * For these port ranges, refer to the "[Install PortSIP PBX](../portsip-pbx-administration-guide/installation-of-portsip-pbx-v22.3-beta-version/install-portsip-pbx.md)" article.
