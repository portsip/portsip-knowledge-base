...
3. If your PortSIP PBX is hosted on a cloud platform such as **AWS, Microsoft Azure, or Google Cloud (GCE)**, you must configure network security rules to allow media traffic.
   ...
   * For these port ranges, refer to the **"**[**Preparing the Server for Installation**](../portsip-pbx-administration-guide/1-installation-of-the-portsip-pbx-1/installation-of-portsip-pbx-v22/install-portsip-pbx-on-linux.md#preparing-the-server-for-installation)**"** article.
