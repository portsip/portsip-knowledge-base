...
> This guide is specifically for upgrades within the **v16.x** series. If you need to upgrade from v16.x to v22.x, please refer to the [Upgrading to the Latest v22.x Release](../installation-of-portsip-pbx-v22.2/upgrade-to-the-latest-version-within-v22.x-on-linux.md).
