...
{% hint style="info" %}
Please follow the [guide ](1-installation-of-the-portsip-pbx/installation-of-portsip-pbx-v16/upgrade-portsip-pbx-to-v16.x.md)to upgrading your PBX to the latest version.
{% endhint %}
