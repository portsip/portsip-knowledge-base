...
### Changes for Release v22.5.2

**Date:** Apr 22, 2026

#### New Features & Enhancements

* Optimized the cleanup process for expired files, such as recording files that are automatically deleted after the tenant-defined retention period.
* For systems upgraded from **v22.2.x or earlier**, starting in **v22.5.2** the expired file cleanup task runs daily at **2:00 AM** and can run for up to **3 hours** per cycle.
* If the cleanup is not completed within the scheduled window, it resumes at **2:00 AM** the next day.
* This change is designed to prevent large-scale cleanup jobs from affecting PBX performance in environments with a high volume of expired recording files.
