...
7. Record the generated provisioning configuration path. You will need this path when configuring DHCP Option 242.
...
<figure><img src="../../../.gitbook/assets/avaya-j-dhcp-7.png" alt=""><figcaption></figcaption></figure>
...
| ---------- | ----------------------------------------------------------- | --------------------------------------------------------------------------------------- |
| `HTTPDIR`  | `/provision/out/b92e699f/4007fb8a8b5e7a490541f7c89ecf332c/` | The secure provisioning path generated by PortSIP PBX.                                  |
