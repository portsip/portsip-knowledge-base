...
If you want to install the IM server with the PBX server on the same server,  please follow the article [Installation of the PortSIP IM Server](../1-installation-of-the-portsip-pbx/installation-of-portsip-pbx-v22/installation-of-the-portsip-im-server.md) to install the PortSIP IM Server for the PBX.
